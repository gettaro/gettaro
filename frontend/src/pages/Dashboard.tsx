              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  <p className="text-sm text-yellow-700 dark:text-yellow-400">
                    No source control integrations are set up. <Link to="/settings/integrations" className="font-medium underline text-yellow-700 dark:text-yellow-400 hover:text-yellow-600 dark:hover:text-yellow-300">Configure integrations</Link> to start tracking your repositories.
                  </p>
                </div>
              </div>
            </div>
